...
class YouTubeUrlTest {
    ...
    @Test
    public void returnsIdsForLongUrls() {
        assertThat(YouTubeUrl.extractVideoId("https://www.youtube.com/watch?v=6RjJFoGt0y4")).isEqualTo("6RjJFoGt0y4");
        assertThat(YouTubeUrl.extractVideoId("https://www.youtube.com/watch?v=RBgcN9lrZ3g&list=PLsn6N7S-aJO3KeJnHmiT3rUcmZqesaj_b&index=9")).isEqualTo("RBgcN9lrZ3g");
    }

    @Test
    public void returnsIdsForShortUrls() {
        assertThat(YouTubeUrl.extractVideoId("https://youtu.be/9_vjHV-nVYY")).isEqualTo("9_vjHV-nVYY");
        assertThat(YouTubeUrl.extractVideoId("https://youtu.be/vw378gNT-Kg")).isEqualTo("vw378gNT-Kg");
        assertThat(YouTubeUrl.extractVideoId("https://youtu.be/9_vjHV-nVYY?t=295")).isEqualTo("9_vjHV-nVYY");
    }
}
