...
* [`src/clj/front_end_v2/`](src/clj/front_end_v2/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/front_end_v2/`](src/cljs/front_end_v2/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/front_end_v2/core.cljs): contains the SPA entry point, `init`
...
(headless test environment)
    * For Chromium, set the `CHROME_BIN` environment variable in your shell to the command that
    launches Chromium. For example, in Ubuntu, add the following line to your `.bashrc`:
       ...
       ```
7. Clone this repo and open a terminal in the `top10` project root directory
...
in the [`src/clj/front_end_v2/`](src/clj/front_end_v2/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/front_end_v2/config.cljs) defaults to `true` in
